...
createheatmap <- function(yorig, ypred, filename = 0, title = 0){
    ...
    x_table2 = x_table / rowSums(x_table) # Normalize the counts such that they are between 0 and 1 (I color the heatmap based on this)
    ...
    # Order of the columns (can be removed if you want default)
    ...
    # Order of the rows (can be removed if you want default)
